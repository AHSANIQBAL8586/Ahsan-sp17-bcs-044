...
class hardlevel extends StatefulWidget {
  @override
  _hardlevel_state createState() => _hardlevel_state();
}

class _hardlevel_state extends State<hardlevel>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Dice Game',style: TextStyle(color: Colors.redAccent,fontWeight: FontWeight.bold,fontSize: 40),textAlign: TextAlign.center,),
